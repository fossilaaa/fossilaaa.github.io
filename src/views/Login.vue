    ...
    <div>
        ...
        <div id="bubble_login">
            <Card>
                ...
                <Divider/>
                <p style="text-align: center">注册登录即代表同意Bubble<span @click="userAgreement = true" style="cursor: pointer; color: #2D8cF0">用户协议</span>和<span @click="privacyPolicy = true" style="cursor: pointer; color: #2D8cF0">隐私协议</span></p>
            </Card>
        </div>
        <Modal
